...
\section{Introdução}
% TODO: Adicionar mais referencias e revisar.
...
\begin{thebibliography}{00}
    \bibitem{Alethe}        ALETHE PAPER HERE, ``Am I watching enough cult movies?'', Novembro de 2023.
    \bibitem{Carcara}       CARCARA PAPER HERE
